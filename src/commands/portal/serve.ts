...
export default class PortalServe extends Command {
  ...
  static readonly description = `Serves the portal described by 'src/portal.json' from your machine, reloading the browser as you edit the Markdown pages in 'src/content'.

Adding or removing a page, editing 'meta.json' or 'portal.json', or changing which documents are in 'src/spec', needs the preview restarted.
