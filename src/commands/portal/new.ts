...
export default class PortalNew extends Command {
  ...
  static override description = 'Generate an API Recipe or Table of Contents (ToC) file for an API Documentation portal.'
  static override examples = [
    '$ apimatic portal:new recipe --name="My API Recipe"',
